          ...
          <div class="col-12">
            <div class="main">
              <div class="judul mt-4">
                <h6 class="text-center">DATA SURAT KELUAR</h6>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="exampleModalLabel">DATA SURAT KELUAR</h1>
                ...
                <table class="table table-success table-striped">
                  ...
                  <tbody>
                    <tr v-for="(document, index) in filteredDocuments" :key="document.id">
                      <td v-if="document.status == 4">{{ index + 1 }}</td>
                      <td v-if="document.status == 4">agenda-{{ index + 1  }}</td>
                      <td v-if="document.status == 4">{{ document.buku_agenda!=null?document.buku_agenda:"-" }}</td>
                      <td v-if="document.status == 4">{{ formatDate(document.created_at) }}</td>
                      <td v-if="document.status == 4">{{ document.no_telegram }}</td>
                      <td v-if="document.status == 4">{{ document.twu }}</td>
                      <td v-if="document.status == 4">{{ document.jenis_surat }}</td>
                      <td v-if="document.status == 4">{{ document.dari }}</td>
                      <td v-if="document.status == 4">{{ document.klasifikasi }}</td>
                      <td v-if="document.status == 4">{{ document.perihal }}</td>
                      <td v-if="document.status == 4">
              ...
              <div class="tombol_nav mt-4">
                <div class="nav_page d-flex justify-content-between">
